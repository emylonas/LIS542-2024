...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="d:cite">
        <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ"><xsl:apply-templates/></a>
    </xsl:template>
    ...
    <xsl:template match='d:p'> [<xsl:value-of select="concat('paragraph ',translate(@n, 'p0', ''))"/>] <xsl:apply-templates/></xsl:template>

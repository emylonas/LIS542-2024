...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        ...
        <html>
            ...
            <body>
                ...
                <!-- does this need to go in a separate div? I don't know, I'm going to put it in its own. -->
                <div>
    ...
    <xsl:template match="d:cite">
        <a href="https://canvas.uw.edu/courses/1724346/assignments/9175267"></a>
       <xsl:apply-templates/>
    </xsl:template>
    ...
    <xsl:template match="d:p">[<xsl:value-of select="concat('paragraph', translate(@n, 'p0', ''))"/>]
        <xsl:apply-templates/>
    </xsl:template>

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="d:cite">
        <a href="https://en.wikipedia.org/wiki/John_Adams"><xsl:apply-templates/></a>
    </xsl:template>
    ...
    <xsl:template match="d:p"> [<xsl:value-of select="concat('page ',translate(@n, 'page0', ''))"/>]<xsl:apply-templates/></xsl:template>

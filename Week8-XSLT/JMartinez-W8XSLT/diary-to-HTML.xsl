...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
        ...
        <html>
            ...
            <body>
                ...
                <div>
                    ...
                    <h1>List of Full Forms</h1>
                    <p>
                        <ol>
                                                       <xsl:for-each select="//d:entries//d:expan" xml:space="preserve">
                                                                <li>
                                                                      <xsl:value-of select="."/>
                                                                    </li>
                                                            </xsl:for-each>
    ...
    <xsl:template match="d:p"> [<xsl:value-of select="concat('paragraph ',translate(@n, 'paragraph0', ''))"/>]<!-- Match <entry>, surround each one with an HTML <p> element and keep going  -->
        <p>
            <xsl:apply-templates/>
        </p>
    </xsl:template>

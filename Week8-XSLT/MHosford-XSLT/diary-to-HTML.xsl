...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xd:doc>
        <xd:desc>  or  select="concat('page ',translate(@n, 'page0', ''))"  for a more elegant display </xd:desc>
    </xd:doc>
    ...
    <xsl:template match="d:cite"> <a href= "{@ref}" ><xsl:apply-templates/></a> </xsl:template>

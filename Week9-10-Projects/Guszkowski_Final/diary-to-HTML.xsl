...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
            ...
            <span class="date">
                <a>
                    <xsl:attribute name="href">
                        <xsl:value-of select="@monthWeather"/>
                    </xsl:attribute>
                    <xsl:apply-templates/>
                </a>
            </span>
    ...
    <xsl:template match="d:quote"> <!-- Enclosing in HTML span element with class attribute so CSS formatting can be applied. -->
        <span class="quote"><xsl:apply-templates/></span>
    </xsl:template>
    
    <xsl:template match="d:margin-note"> <!-- Enclosing in HTML span element with class attribute so CSS formatting can be applied. -->

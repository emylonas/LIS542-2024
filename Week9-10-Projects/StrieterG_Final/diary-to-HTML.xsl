...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xd:doc scope="stylesheet">
        <xd:desc>
            ...
            <xd:p><xd:b> Edited on:</xd:b> June 1st, 2024</xd:p>
            <xd:p><xd:b>Edited by:</xd:b>Gil Strieter</xd:p>
    ...
    <xsl:template match="/">
        ...
        <html>
            ...
            <body>
                ...
                <h1>
                    <xsl:value-of select="/d:journal/d:metadata/d:sourceInfo/d:publisher"/>
                </h1>
                <xsl:apply-templates/>

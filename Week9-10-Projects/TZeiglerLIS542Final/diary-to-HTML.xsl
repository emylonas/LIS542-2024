    ...
    <xsl:template match="/">
        ...
        <html>
            ...
            <body>
                ...
                <!-- Attempting to create a list of the local places mentioned in the text with a location attribute that links to a mapping site -->
                <div>
                ...
                <p>
                  <ol>
                                <xsl:for-each select="//d:entries//d:place" xml:space="preserve">
                                    <li>
                                        <xsl:value-of select="."/> (<xsl:value-of select="@ref"/>)
                                        </li>
                                        </xsl:for-each>
                   </ol>
                   </p>

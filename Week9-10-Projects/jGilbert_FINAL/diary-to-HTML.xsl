...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        ...
        <html>
            ...
            <body>
                ...
                <div>
                    <p><xsl:for-each select="//d:entries//d:q" xml:space="preserve"> </xsl:for-each>
                    </p>
                </div>
    ...
    <xsl:template match="d:documentation">
    ...
    <xsl:template match="d:q">
        <p>
        <q class="q"><xsl:apply-templates/></q>
        </p>
    </xsl:template>
    ...
    <xsl:template match="d:pb"> [<xsl:value-of select="@n"/>]
        <span class="page"><xsl:apply-templates/></span>
    </xsl:template>
    
    <xsl:template match="d:p"> [<xsl:value-of select="@n"/>]
        <xsl:apply-templates/>
    </xsl:template>
    
    <xsl:template match="d:cite">
        <a href="https://www.kingjamesbibleonline.org/Titus-3-5/">Source</a> 
    </xsl:template>
